    ...
    public void count_Stats_for_map(byte[][][] actions_hand,String[] idplayers,float[]stacks,byte Seaters,float[][]posactions,boolean isAdditional){
        ...
        for(int posRFI=0; posRFI<5; posRFI++){
            ...
            for(int posAgainstRFI = 1+posRFI; posAgainstRFI<6; posAgainstRFI++){
                ...
                Integer[][][] stata = map_of_Idplayer_stats.get(idplayers[posAgainstRFI]);
                ...
                map_of_Idplayer_stats.put(idplayers[posAgainstRFI],stata);
            ...
            Integer[][][] stata = map_of_Idplayer_stats.get(idplayers[5]);
            ...
            map_of_Idplayer_stats.put(idplayers[5],stata);
