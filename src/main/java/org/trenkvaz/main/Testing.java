...
public class Testing {
    ...
    static void show_HashShablonNumber(int[] shortarr_shablon,int W,int H){
        ...
        for(int y=0; y<H; y++){
            for(int x=0; x<W; x++){
               ...
               int index_in_arrlong = coord_in_arr_long/32;
                ...
                int pixl = pix&(short)1<<(s-index_bit);
        ...
        for(int x=0; x<W; x++){
            for(int y=0; y<H; y++){
                ...
                //System.out.println(coord_in_arr_long+"  "+index_in_arrlong+"  "+index_bit);
                int pix = shortarr_shablon[index_in_arrlong];
                // так как бит берется слева его индекс это сдвиг маски(единички) на (количество битов в используемом числе минус 1 (так как полный сдвиг все биты сдвинет)),
    ...
    public static void main(String[] args) throws Exception {
       ...
       show_HashShablonNumber(num.get(0),6,9);
        //show_HashShablonNumber(shablons_numbers_0_9[5],8,12);
        ////////////////////////////////////////////////////////////////////////////////////////////////////////
    }
}
